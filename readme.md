...
- [ ] Для позиционирования элементов выбран верный подход, описанный корректным синтаксисом. 
    ...
    *Отступы между блоками следует назначать блокам, но не их внутренним элементам:
    ...
    В блоках `results`, `footer` следует задать блокам общие отсупы слева и справа вместо указания отступов для каждого внутреннего элемента. 
